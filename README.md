...
> 各ステップの具体コマンドは [`docs/infrastructure.md`](docs/infrastructure.md) の
> 「ブートストラップ順序（新規 clone から）」、リポジトリ変数の全量は
> [`docs/repository-variables.md`](docs/repository-variables.md) を参照。
